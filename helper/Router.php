...
class Router
{
    ...
    private function getControllerFrom($module)
    {
        ...
        $validController = method_exists("Configuracion", $controllerName) ? $controllerName : $this->defaultController;
        return call_user_func(array("Configuracion", $validController));
    }

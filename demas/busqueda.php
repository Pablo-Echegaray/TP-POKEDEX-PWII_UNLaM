...
<body>
    ...
    $conex = Configuracion::getDatabase();
    $result = $conex->query($busqueda);
    ...
    $result = $conex->query(obtenerPokemones());
    } 
    ...
    //while ($row = mysqli_fetch_assoc($result)) {
        ...
        if (isset($_SESSION["usuario"])) {
            ...
            // ELIMINAR POKEMON
            echo "<form action='index.php?controller=EliminarPokemons&action=deletePokemons' method='post'>";
            echo "<input type='hidden' name='pokemon_id' value='" . $row['id'] . "'>";
